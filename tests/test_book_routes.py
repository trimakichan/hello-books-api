...
def test_get_all_books_with_no_records(client):
    # Act
    # We get a Response object/Response instance
...
def test_get_all_books_with_desc_query_matching_none(client, two_saved_books):
    # Act
    data = {'description': 'Cat has an adventure..'}
    response = client.get("/books", query_string=data)
    response_body = response.get_json()
...
def test_get_all_books_with_desc_query_matching_one(client, two_saved_books):
    # Act
    data = {'description': 'i luv 2 climb rocks'}
    response = client.get("/books", query_string=data)
    response_body = response.get_json()
